const resetPassword = function (otp: string, email: string) {
    const html = `
    <!DOCTYPE html>
...
<body
  ...
  <div style="display: none;">A request to reset password was received from your MediPlan Account</div>
  <div role="article" aria-roledescription="email" aria-label="Reset your Password" lang="en">
                ...
                <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0"
                  ...
                  <tr>
                    <td class="sm-px-24"
                      ...
                      <p style="font-weight: 600; font-size: 18px; margin-bottom: 10px;margin-top: 10px">Hey ${email},</p>

                      <p style="margin: 0 0 24px;">
                        This is the password reset OTP you requested from MediPlan. Use to reset your MediPlan account password.
                      </p>
    ...
    const text = `
        Reset Password, You recently requested to reset your password for your MediPlan account. Copy and paste it for reset password:
        ${otp}
