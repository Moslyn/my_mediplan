const verifyEmailTemplate = function (otp: string) {
    ...
    <body
      ...
      <div style="display: none;">A request to create your MediPlan account was received.
                      ...
                      <tr>
                        <td class="sm-px-24"
                          ...
                          <p style="margin: 0 0 24px;">
                            A request to create your MediPlan account was received.
Use this link to confirm your account and log in
                          </p>

                          <h3><lable style="display: block; font-size: 24px; line-height: 100%; margin-bottom: 24px; --text-opacity: 1; color: #000000; text-decoration: none;">${otp}</lable><h3>
                          ...
                          <p style="margin: 0 0 16px;">Thanks, <br>The MediPlan Support Team</p>
                        </td>
                      </tr>
                      <tr>
    ...
    const text = `
        Verify Email, A request to create your MediPlan account was received.
